...
<div class="container mt-5 editpedido">
    ...
    <div class="mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="<?= base_url('pedidos/print/' . $pedido->id_pedido . '?volver=' . urlencode(current_url())) ?>" class="boton btnImprimir" target="_blank">
                Imprimir Pedido
