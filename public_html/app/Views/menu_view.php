...
<div class="d-flex justify-content-between mb-3 btnFamiliaProveedor">
    ...
    <button class="boton btnAdd" id="btnAddMenu" data-toggle="modal" data-target="#menuModal">Añadir Menú
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <a href="/menu" class="close" data-dismiss="modal" aria-label="Close"> <span
            ...
            <div class="modal-body">
                ...
                <form id="editMenuForm">
                    ...
                    <div class="buttonsEditProductProveedAbajo">
                        <button type="submit" class="boton btnGuardar saveProveedor">Guardar Cambios<svg
                                xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 27"
                                fill="none">
                                <path
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addMenuForm">
                    ...
                    <div class="buttonsEditProductProveedAbajo">
                        <button type="submit" class="boton btnGuardar saveProveedor">Añadir Menú<svg
                                xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 27"
                                fill="none">
                                <path
                                    d="M7.11751 6.91875C6.86324 6.91875 6.61937 7.01976 6.43957 7.19956C6.25977 7.37936 6.15876 7.62322 6.15876 7.8775V19.3825C6.15876 19.6368 6.25977 19.8806 6.43957 20.0604C6.61937 20.2402 6.86324 20.3413 7.11751 20.3413H18.6225C18.8768 20.3413 19.1207 20.2402 19.3005 20.0604C19.4803 19.8806 19.5813 19.6368 19.5813 19.3825V7.8775C19.5813 7.62322 19.4803 7.37936 19.3005 7.19956C19.1207 7.01976 18.8768 6.91875 18.6225 6.91875H14.3081C14.0539 6.91875 13.81 7.01976 13.6302 7.19956C13.4504 7.37936 13.3494 7.62322 13.3494 7.8775V14.8697L15.8862 12.3319C15.9763 12.2418 16.0983 12.1913 16.2256 12.1913C16.3529 12.1913 16.475 12.2418 16.565 12.3319C16.655 12.4219 16.7056 12.544 16.7056 12.6712C16.7056 12.7985 16.655 12.9206 16.565 13.0106L13.2094 16.3663C13.1649 16.4109 13.112 16.4463 13.0537 16.4705C12.9955 16.4947 12.9331 16.5071 12.87 16.5071C12.807 16.5071 12.7445 16.4947 12.6863 16.4705C12.628 16.4463 12.5751 16.4109 12.5306 16.3663L9.17499 13.0106C9.13042 12.9661 9.09506 12.9132 9.07094 12.8549C9.04682 12.7967 9.03441 12.7343 9.03441 12.6712C9.03441 12.6082 9.04682 12.5458 9.07094 12.4876C9.09506 12.4293 9.13042 12.3764 9.17499 12.3319C9.21956 12.2873 9.27247 12.2519 9.33071 12.2278C9.38894 12.2037 9.45136 12.1913 9.51439 12.1913C9.57742 12.1913 9.63983 12.2037 9.69807 12.2278C9.7563 12.2519 9.80921 12.2873 9.85379 12.3319L12.3906 14.8697V7.8775C12.3906 7.36895 12.5927 6.88122 12.9523 6.52162C13.3119 6.16202 13.7996 5.96 14.3081 5.96H18.6225C19.1311 5.96 19.6188 6.16202 19.9784 6.52162C20.338 6.88122 20.54 7.36895 20.54 7.8775V19.3825C20.54 19.8911 20.338 20.3788 19.9784 20.7384C19.6188 21.098 19.1311 21.3 18.6225 21.3H7.11751C6.60896 21.3 6.12124 21.098 5.76164 20.7384C5.40203 20.3788 5.20001 19.8911 5.20001 19.3825V7.8775C5.20001 7.36895 5.40203 6.88122 5.76164 6.52162C6.12124 6.16202 6.60896 5.96 7.11751 5.96H9.51439C9.64153 5.96 9.76346 6.0105 9.85336 6.1004C9.94326 6.19031 9.99376 6.31224 9.99376 6.43937C9.99376 6.56651 9.94326 6.68844 9.85336 6.77834C9.76346 6.86824 9.64153 6.91875 9.51439 6.91875H7.11751Z"
...
<script>
        ...
        const columnDefs = [
            {
                ...
                cellRenderer: function (params) {
                    return ` 
                <button onclick="editMenu(${params.data.id})" class="btn botonTabla btnEditarTabla">Editar
                ...
                <a href="<?= base_url('menu/submenus') ?>/${params.data.id}" class="btn botonTabla btnSubmenu">Submenú
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="27" viewBox="0 0 26 27" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M10.3744 16.7276C10.3744 16.6206 10.4166 16.518 10.4916 16.4423C10.5667 16.3666 10.6685 16.3241 10.7746 16.3241H17.9791C18.0852 16.3241 18.187 16.3666 18.2621 16.4423C18.3372 16.518 18.3793 16.6206 18.3793 16.7276C18.3793 16.8346 18.3372 16.9372 18.2621 17.0129C18.187 17.0885 18.0852 17.131 17.9791 17.131H10.7746C10.6685 17.131 10.5667 17.0885 10.4916 17.0129C10.4166 16.9372 10.3744 16.8346 10.3744 16.7276ZM10.3744 13.5C10.3744 13.393 10.4166 13.2904 10.4916 13.2147C10.5667 13.1391 10.6685 13.0965 10.7746 13.0965H17.9791C18.0852 13.0965 18.187 13.1391 18.2621 13.2147C18.3372 13.2904 18.3793 13.393 18.3793 13.5C18.3793 13.607 18.3372 13.7096 18.2621 13.7853C18.187 13.8609 18.0852 13.9034 17.9791 13.9034H10.7746C10.6685 13.9034 10.5667 13.8609 10.4916 13.7853C10.4166 13.7096 10.3744 13.607 10.3744 13.5ZM10.3744 10.2724C10.3744 10.1654 10.4166 10.0628 10.4916 9.98713C10.5667 9.91147 10.6685 9.86896 10.7746 9.86896H17.9791C18.0852 9.86896 18.187 9.91147 18.2621 9.98713C18.3372 10.0628 18.3793 10.1654 18.3793 10.2724C18.3793 10.3794 18.3372 10.482 18.2621 10.5577C18.187 10.6334 18.0852 10.6759 17.9791 10.6759H10.7746C10.6685 10.6759 10.5667 10.6334 10.4916 10.5577C10.4166 10.482 10.3744 10.3794 10.3744 10.2724ZM7.97292 11.0793C8.18522 11.0793 8.38883 10.9943 8.53895 10.843C8.68907 10.6917 8.77341 10.4864 8.77341 10.2724C8.77341 10.0584 8.68907 9.85317 8.53895 9.70185C8.38883 9.55053 8.18522 9.46552 7.97292 9.46552C7.76061 9.46552 7.557 9.55053 7.40688 9.70185C7.25676 9.85317 7.17242 10.0584 7.17242 10.2724C7.17242 10.4864 7.25676 10.6917 7.40688 10.843C7.557 10.9943 7.76061 11.0793 7.97292 11.0793ZM7.97292 14.3069C8.18522 14.3069 8.38883 14.2219 8.53895 14.0706C8.68907 13.9192 8.77341 13.714 8.77341 13.5C8.77341 13.286 8.68907 13.0808 8.53895 12.9294C8.38883 12.7781 8.18522 12.6931 7.97292 12.6931C7.76061 12.6931 7.557 12.7781 7.40688 12.9294C7.25676 13.0808 7.17242 13.286 7.17242 13.5C7.17242 13.714 7.25676 13.9192 7.40688 14.0706C7.557 14.2219 7.76061 14.3069 7.97292 14.3069ZM7.97292 17.5345C8.18522 17.5345 8.38883 17.4495 8.53895 17.2981C8.68907 17.1468 8.77341 16.9416 8.77341 16.7276C8.77341 16.5136 8.68907 16.3083 8.53895 16.157C8.38883 16.0057 8.18522 15.9207 7.97292 15.9207C7.76061 15.9207 7.557 16.0057 7.40688 16.157C7.25676 16.3083 7.17242 16.5136 7.17242 16.7276C7.17242 16.9416 7.25676 17.1468 7.40688 17.2981C7.557 17.4495 7.76061 17.5345 7.97292 17.5345Z" fill="white"/>
            </svg></a>
            <button onclick="deleteMenu(${params.data.id})" class="btn botonTabla btnEliminarTabla">Eliminar
    ...
    function deleteMenu(id) {
        if (confirm('¿Estás seguro de que quieres eliminar este menú y sus menús dependientes?')) {
            $.ajax({
