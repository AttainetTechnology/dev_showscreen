...
<div class="d-flex justify-content-between mb-3 btnFamiliaProveedor">
    <button onclick="abrirModalAgregar()" class="boton btnAdd">Añadir Vacaciones
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editVacacionesForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="desde" name="desde" placeholder="dd/mm/yyyy"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="hasta">Hasta</label>
                        <input type="text" class="form-control" id="hasta" name="hasta" placeholder="dd/mm/yyyy"
                            required>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="boton btnGuardar" id="saveEditBtn">Guardar Cambios
...
<script>
    ...
    function actionCellRenderer(params) {
        ...
        return `
            <button onclick="editarVacaciones('${params.data.id}', '${params.data.user_id}', '${params.data.desde}', '${params.data.hasta}', '${params.data.observaciones}')" class="btn botonTabla btnEditarTabla" title="Editar">Editar
            ...
            <button onclick="eliminarVacaciones('${params.data.id}')" class="btn botonTabla btnEliminarTabla" title="Eliminar">Eliminar
