...
<a href="<?= base_url('Pedidos_proveedor/addPedido') ?>"  class="btn boton btnAdd" style="margin-left: 25px;">
        Añadir Pedido
        ...
        const columnDefs = [{
                ...
                cellRenderer: function(params) {
                    ...
                    return `
                        ...
                        <a href="${acciones.imprimir}" class="btn botonTabla btnImprimirTabla" target="_blank">
                        Imprimir
                        ...
                        <button onclick="eliminarPedido('${acciones.eliminar}')" class="btn botonTabla btnEliminarTabla">
                        Eliminar
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
