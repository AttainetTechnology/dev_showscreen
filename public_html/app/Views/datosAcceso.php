    ...
    <form id="editUserForm" action="<?= base_url('password/save/' . $user['id']) ?>" method="post">
        ...
        <div class="form-group password-container">
            ...
            <div id="eye-icon" onclick="togglePassword()">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" id="eye-icon-slash" width="20" height="20" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" id="eye-icon-open" width="20" height="20" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16" style="display:none;">
