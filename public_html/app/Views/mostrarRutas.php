    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        `,
            ...
            { headerName: "Fecha", field: "fecha_ruta", sortable: true, filter: true },
            {
                ...
                sortable: true,
                filter: true,
                valueFormatter: params => estadoMap[params.value] || " " // Mapea los valores
            },
            { headerName: "Cliente", field: "nombre_cliente", sortable: true, filter: true }, // Mostrar el nombre del cliente
            { headerName: "Población", field: "nombre_poblacion", sortable: true, filter: true }, // Mostrar el nombre de la población
            { headerName: "Lugar", field: "lugar", sortable: true, filter: true },
            {
                ...
                sortable: true,
                filter: true,
                valueFormatter: params => recogidaEntregaMap[params.value] || " " // Mapea los valores
            },
            { headerName: "Transportista", field: "nombre_transportista", sortable: true, filter: true }, // Mostrar el nombre del transportista
            {
                headerName: "Pedido",
                field: "id_pedido",
                cellRenderer: params => {
        ...
        // Función para ajustar el tamaño de las columnas cuando la ventana cambie de tamaño
        function onResize() {
        ...
        window.editRuta = function (id) {
            window.location.href = `/editar_rutas/${id}`;
        };
        document.getElementById('add-ruta-btn').addEventListener('click', function () {
            window.location.href = '/rutas/add_ruta';
        });
        ...
        document.getElementById('clear-filters').addEventListener('click', function () {
            gridApi.setFilterModel(null); // Limpia todos los filtros de la tabla
            gridApi.onFilterChanged(); // Actualiza la tabla
        });
    });
</script>
