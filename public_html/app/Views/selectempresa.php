...
<div class="d-flex justify-content-between mb-3 btnFamiliaProveedor">
    <button onclick="abrirModalAgregar()" class="boton btnAdd">Añadir Empresa
            ...
            <div class="modal-body">
                <form id="formEditarEmpresa" method="POST" action="<?= base_url('select_empresa/editar') ?>"
                    ...
                    <div class="buttonsEditProductProveedAbajo">
                        <button type="submit" class="btn boton btnGuardar">Guardar Cambios
        ...
        const columnDefs = [
            {
                ...
                cellRenderer: params => {
                    return `
                    <button onclick="editarEmpresa(${params.data.id})" class="btn botonTabla btnEditarTabla">Editar
                    ...
                    <button onclick="accederEmpresa(${params.data.id})" class="btn botonTabla volverButtonTabla">Acceder
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.77016 2.39224C6.77016 2.21886 6.83786 2.05258 6.95836 1.92998C7.07885 1.80738 7.24228 1.7385 7.41269 1.7385H17.6932C17.8636 1.7385 18.027 1.80738 18.1475 1.92998C18.268 2.05258 18.3357 2.21886 18.3357 2.39224V14.1595C18.3357 14.3329 18.268 14.4991 18.1475 14.6217C18.027 14.7443 17.8636 14.8132 17.6932 14.8132H7.41269C7.24228 14.8132 7.07885 14.7443 6.95836 14.6217C6.83786 14.4991 6.77016 14.3329 6.77016 14.1595V11.5445C6.77016 11.3712 6.70247 11.2049 6.58197 11.0823C6.46147 10.9597 6.29805 10.8908 6.12764 10.8908C5.95723 10.8908 5.7938 10.9597 5.6733 11.0823C5.5528 11.2049 5.48511 11.3712 5.48511 11.5445V14.1595C5.48511 14.6796 5.68819 15.1785 6.04968 15.5463C6.41118 15.9141 6.90147 16.1207 7.41269 16.1207H17.6932C18.2044 16.1207 18.6947 15.9141 19.0562 15.5463C19.4177 15.1785 19.6207 14.6796 19.6207 14.1595V2.39224C19.6207 1.87209 19.4177 1.37325 19.0562 1.00545C18.6947 0.637657 18.2044 0.43103 17.6932 0.43103H7.41269C6.90147 0.43103 6.41118 0.637657 6.04968 1.00545C5.68819 1.37325 5.48511 1.87209 5.48511 2.39224V5.00718C5.48511 5.18056 5.5528 5.34684 5.6733 5.46944C5.7938 5.59204 5.95723 5.66092 6.12764 5.66092C6.29805 5.66092 6.46147 5.59204 6.58197 5.46944C6.70247 5.34684 6.77016 5.18056 6.77016 5.00718V2.39224Z" fill="white"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.2929 8.7387C14.3527 8.67798 14.4002 8.60584 14.4326 8.52641C14.465 8.44699 14.4816 8.36185 14.4816 8.27586C14.4816 8.18987 14.465 8.10473 14.4326 8.0253C14.4002 7.94588 14.3527 7.87374 14.2929 7.81301L10.4377 3.8906C10.3779 3.82982 10.307 3.7816 10.229 3.74871C10.1509 3.71581 10.0673 3.69888 9.98278 3.69888C9.89829 3.69888 9.81464 3.71581 9.73658 3.74871C9.65853 3.7816 9.58761 3.82982 9.52787 3.8906C9.46813 3.95138 9.42074 4.02354 9.38841 4.10295C9.35608 4.18237 9.33944 4.26749 9.33944 4.35344C9.33944 4.4394 9.35608 4.52452 9.38841 4.60393C9.42074 4.68335 9.46813 4.75551 9.52787 4.81629L12.2869 7.62212H0.987377C0.816968 7.62212 0.653538 7.691 0.533041 7.8136C0.412543 7.9362 0.344849 8.10248 0.344849 8.27586C0.344849 8.44924 0.412543 8.61552 0.533041 8.73812C0.653538 8.86072 0.816968 8.92959 0.987377 8.92959H12.2869L9.52787 11.7354C9.46813 11.7962 9.42074 11.8684 9.38841 11.9478C9.35608 12.0272 9.33944 12.1123 9.33944 12.1983C9.33944 12.2842 9.35608 12.3693 9.38841 12.4488C9.42074 12.5282 9.46813 12.6003 9.52787 12.6611C9.58761 12.7219 9.65853 12.7701 9.73658 12.803C9.81464 12.8359 9.89829 12.8528 9.98278 12.8528C10.0673 12.8528 10.1509 12.8359 10.229 12.803C10.307 12.7701 10.3779 12.7219 10.4377 12.6611L14.2929 8.7387Z" fill="white"/>
                    </svg></button>
                    <button onclick="eliminarEmpresa(${params.data.id})" class="btn botonTabla btnEliminarTabla">Eliminar
