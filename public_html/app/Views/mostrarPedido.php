    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var columnDefs = [{
                ...
                cellRenderer: function(params) {
                    var editBtn = `<a href="<?= base_url('pedidos/edit/') ?>${params.data.id_pedido}" class="btn botonTabla btnEditar">
                    Editar
                    ...
                    var printBtn = `<a href="<?= base_url('pedidos/print/') ?>${params.data.id_pedido}" class="btn botonTabla btnImprimir" target="_blank">
                    Imprimir
                    ...
                    var deleteBtn = allowDelete ? `<a href="<?= base_url('pedidos/delete/') ?>${params.data.id_pedido}" class="btn botonTabla btnEliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este pedido?');">
                    Eliminar
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
