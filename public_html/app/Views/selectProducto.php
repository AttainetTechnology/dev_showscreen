...
<script>
    ...
    $('.btn-select').on('click', function() {
        ...
        var nombreProducto = $(this).closest('tr').find('td:first').text(); // Obtener el nombre del producto
        ...
        $.post('<?= base_url('productos_necesidad/actualizarProductoVenta') ?>', {
            ...
            if (response.success) {
                if (action === 'select') {
                    alert("Has seleccionado " + nombreProducto); // Alerta para selección
                    ...
                    alert("Has deseleccionado " + nombreProducto); // Alerta para deselección
