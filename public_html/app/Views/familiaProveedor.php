    ...
    document.addEventListener('DOMContentLoaded', function() {
        const columnDefs = [{
                ...
                cellRenderer: params => {
                    ...
                    return `
                <button onclick="editarFamilia('${links.editar}', '${params.data.nombre}', '${params.data.id_familia}')" class="btn botonTabla btnEditarTabla" title="Editar">
                Editar
                ...
                <button onclick="eliminarFamilia('${links.eliminar}')" class="btn botonTabla btnEliminarTabla btn-sm" title="Eliminar">
                Eliminar
