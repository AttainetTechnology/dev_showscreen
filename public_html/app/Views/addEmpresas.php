<form id="addEmpresaForm">
    ...
    <div class="modal-body">
        <div class="d-flex justify-content-end">
            <button type="button" class="boton btnGuardar" onclick="guardarEmpresa()">Guardar
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="cargaen" name="cargaen">
        </div>
        <div class="mb-3">
            <label for="exportacion" class="form-label">Exportación</label>
            <input type="text" class="form-control" id="exportacion" name="exportacion">
        </div>
        <div class="mb-3">
...
<script>
    function guardarEmpresa() {
        var formData = $('#addEmpresaForm').serialize();
        $.ajax({
            url: '<?= base_url("empresas/add") ?>',
            type: 'POST',
            data: formData,
