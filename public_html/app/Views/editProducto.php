...
<form action="<?= base_url("productos/editarProducto/{$producto['id_producto']}") ?>" method="post"
   ...
   <?php if (!empty($producto['imagen'])): ?>
    <div>
        <br>
        <img src="<?= base_url("public/assets/uploads/files/{$data['id_empresa']}/productos/{$producto['imagen']}") ?>" 
     alt="Imagen Producto" style="width: 100px; height: 100px;">

        <button type="button" class="btn boton btnEliminar" onclick="eliminarImagen(<?= $producto['id_producto'] ?>)">
