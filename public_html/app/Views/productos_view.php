        ...
        <!-- Opciones dinámicamente añadidas -->
            ...
            <div class="modal-footer">
                <div class="buttonsEditProductProveedAbajo">
                    <button type="button" class="boton volverButton" data-bs-dismiss="modal">Volver
                    ...
                    <button type="button" class="boton btnGuardar" id="guardarProductoBtn"
                        onclick="guardarProducto()">Guardar Producto
...
<script>
    ...
    function accionesRenderer(params) {
        return `
            <button onclick="editarProducto(${params.data.id_producto})" class="btn botonTabla btnEditarTabla">Editar
            ...
            <button onclick="eliminarProducto(${params.data.id_producto})" class="btn botonTabla btnEliminarTabla">Eliminar
             <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
