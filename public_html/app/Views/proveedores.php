...
<a href="<?= base_url('proveedores/add') ?>" class="btn boton btnAdd" style="margin-left: 25px;">
        Añadir Proveedor
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const columnDefs = [{
                ...
                cellRenderer: params => {
                    ...
                    <button onclick="eliminarProveedor('${links.eliminar}')" class="btn botonTabla btnEliminarTabla">
                    Eliminar
