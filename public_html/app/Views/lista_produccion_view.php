...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        {
    headerName: "Piezas / Último Fichaje",
    field: "n_piezas",
    filter: 'agTextColumnFilter',
    minWidth: 150,
    cellRenderer: function (params) {
        const nPzas = params.value || ''; // Si n_pzas es null o undefined, usa una cadena vacía
        const ultimoFichaje = params.data.ultimo_fichaje && params.data.ultimo_fichaje != 0 
            ...
            : ''; // Si ultimo_fichaje no es vacío o cero, lo muestra como enlace con tooltip
