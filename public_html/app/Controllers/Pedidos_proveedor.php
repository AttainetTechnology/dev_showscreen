...
class Pedidos_proveedor extends BaseControllerGC
{
    ...
    public function saca_precio_linea($post_array)
    {
        ...
        $n_piezas = $post_array->data['n_piezas'] ?? 0;  // Asegurarse de que n_piezas sea 0 si no está presente
        ...
        if ($query_pedido->getNumRows() > 0) {
            ...
            // Asegurarse de que el precio sea un número válido, de lo contrario asignar 0
